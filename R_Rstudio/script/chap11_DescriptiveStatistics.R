...
median(score3) # 50 : c(60, 60, 50, 40, 40)
...
# ((85-87.2)^2+(90-87.2)^2+(93-87.2)^2+(86-87.2)^2+(82-87.2)^2)/5 = 14.96
var(score1)    # [1] 18.7
sd(score1)     # [1] 4.32435
...
# 실습 데이터 셋 가져오기
data <- read.csv("D:/DevWork/workspaces_bigdata/R_Rstudio/data/descriptive.csv", header = T)
View(data)
