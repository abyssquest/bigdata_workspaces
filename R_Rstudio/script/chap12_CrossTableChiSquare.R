...
# 1) 실습 파일 가져오기
data <- read.csv("D:\\DevWork\\workspaces_bigdata\\R_Rstudio\\data\\cleanDescriptive.csv", header = T)
View(data)
head(data) # 변수 확인
...
# 1. 파일 가져오기
data <- read.csv("D:/DevWork/workspaces_bigdata/R_Rstudio/data/homogenity.csv", header = T)
View(data)
